...
class enemy():
    ...
    def __init__(self, x, y, width, height, end):
        ...
        self.width = width
        self.height = height
        self.path = [x, end]    # x開始的座標， end 結束的座標
        self.walkCount = 0
        self.vel = 3
...
while run:
  ...
  # 判断y 坐标
  # man.hitbox[1] = 上线   
  # goblin.hitbox[1] + goblin.hitbox[3] = 下线  

  # man.hitbox[1] + man.hitbox[3] = 下线
  # goblin.hitbox[1] = 上线
  """
...
#   self.hitbox = (self.x, self.y, 29, 52)
  ...
  for bullet in bullets:
    ...
    判斷 Y 座標是否碰到，hitbox
    子弹远点由，x，y 开始画。
    bullet.y - bullet.radius = 子彈顶部
    goblin.hitbox[1] + goblin.hitbox[3] = 哥布林腳底

    bullet.y + bullet.radius = 子彈底部
    goblin.hitbox[1] = 哥布林頭頂
    ...
    if bullet.y - bullet.radius < goblin.hitbox[1] + goblin.hitbox[3] and bullet.y + bullet.radius > goblin.hitbox[1]:
        ...
        """
        判斷 X 座標是否碰到，hitbox
        bullet.x + bullet.radius = 子彈右側
        goblin.hitbox[0] = 左側

        bullet.x - bullet.radius = 子彈左側
        goblin.hitbox[0] + goblin.hitbox[2] = 哥布林右側
        """
